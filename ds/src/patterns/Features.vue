    ...
    <div v-if="tab === 1" style="width: 100%">
      ...
      <div class="cx-3">
        ...
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Múltiplos atendimentos, múltiplos endereços, múltiplos recebimentos e muitos outros
              múltiplos funcionando na nuvem e fora dela quando não há conexão com a internet.
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              ...
              linha de destino pode ser nomeada, permitindo um atendimento personalizado e medição
              das vendas por telefone divulgado.
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative">
    ...
    <div v-if="tab === 2" style="width: 100%">
      ...
      <div class="cx-3">
        ...
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Precisa alterar dados de um atendimento, como a forma de pagamento no pedido
              finalizado? Faça isso na hora, sem precisar cancelar a venda e perder tempo.
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Atendentes ou vendedores precisam se comunicar rapidamente durante um atendimento? É
              só iniciar um chat em tempo real dentro do pedido!
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative">
          ...
          <div>
            <p class="text">
              Durante o processo de venda assinale poucos campos que podem ser obrigatórios ou não
              para gerar indicadores importantes sobre seus canais de divulgação e grupos de
              cliente.
            </p>
          </div>
        </div>
    ...
    <div v-if="tab === 3" style="width: 100%">
      ...
      <div class="cx-3">
        ...
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Qual é prioridade das entregas? Os pedidos possuem indicação de urgência por escala de
              cor, minutos transcorridos e pedidos agendados
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Desenhe no mapa suas regiões de atendimento, acompanhe o deslocamento de seus agentes
              de logística e a proximidade com os clientes, trace rotas para entender o histórico
              das entregas
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative">
          ...
          <div>
            <p class="text">
              Controle o estoque e itens em trânsito por entrada manual ou QR Code. Atualize o nível
              de estoque pelas compras e fechamento das vendas nos aplicativos.
            </p>
          </div>
        </div>
      </div>
    ...
    <div v-if="tab === 4" style="width: 100%">
      ...
      <div class="cx-3">
        ...
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Cada operador com perfil de vendas tem sua própria conta/carteira. Sendo possível
              realizar conferência de entregas, sangria de caixa e lançamento de despesas de forma
              simplificada
            </p>
          </div>
        </div>
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Analisar o Fluxo de caixa e o Demostrativo de Resultados Operacional é fundamental
              para o sucesso do negócio, cuidamos para que esses dados sejam apresentados de forma
              de objetiva. Você só precisa fazer os lançamentos de despesas de forma precisa, já que
              as vendas são
            </p>
          </div>
        </div>
    ...
    <div v-if="tab === 5" style="width: 100%">
      ...
      <div class="cx-3">
        ...
        <div class="col-md-6 c" style="position:relative;">
          ...
          <div>
            <p class="text">
              Relatórios e indicadores precisos por vendedor, veículos, posição do estoque nas
              bases, em trânsito, mcmm
            </p>
          </div>
        </div>
        <div class="col-md-6" style="position:relative;">
          ...
          <div>
            <p class="text">
              No GestaON você pode mapear todos os clientes em potenciais de uma região e comparar
              com as vendas realizadas, fica fácil saber para onde direcionar sua próxima ação de
              marketing
            </p>
          </div>
        </div>
