...
$color-placeholder: tint($color-base-40, 50%);
...
.textarea {
  ...
  textarea {
    ...
    margin: 0;
    border: 0;
    box-shadow: inset 0 1px 0 0 rgba($color-black, 0.07),
      0 0 0 1px tint($color-black, 80%);
    ...
    &.focus {
      ...
      box-shadow: inset 0 0 0 1px $color-primary, 0 0 0 1px $color-primary;
      outline: 0;
    }
    &[disabled] {
      -webkit-font-smoothing: antialiased;
