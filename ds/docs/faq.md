## What is the GestaON DS?

GestaON DS is an open source tool for building UI Design Systems with [Vue.js](https://vuejs.org). It provides you and your team a set of organized tools, patterns & practices that work as the foundation for your application development. [Read more about it](https://viljamis.com/2018/vue-design-system/).
...
Organizations that have more than just Vue.js based applications can benefit from GestaON DS as well. Tokens which store visual design attributes are universal and can be used on any platform. GestaON DS also renders all components in both Vue.js & HTML which allows you to use the components on any web based platform. Additionally, it’s possible to configure the build process to output Web Components instead of Vue.js Components.

## Why aren’t there more components by default?

GestaON DS is not a front-end component library and never will be. Instead it tries to provide you and your team a set of organized tools, patterns & practices to build upon, so that you can get started with the actual design system faster.
...
## Does GestaON DS work on Windows?
...
## Does GestaON DS work with Nuxt.js?
...
## I can’t get GestaON DS working as an NPM dependency?
