...
Vue.set(Vue.prototype, "modelDefinitions", {
  ...
  searchModels: {
    searchClients:
      "id, name, address, number, complement, neighborhood, city, state",
    searchAddresses:
      "id, name, address, neighborhood, city, state, cep, country"
  },
  stateModels: {
    STATE_cards:
      "id, windowId, type, requestId, orderSubtotal, clientName, clientAddress",
    ...
    STATE_requestOrders:
      "id, obs, promotionChannelId, status, dateUpdated, dateCreated, dateRemoved",
    STATE_clients: "id, name, document, clientGroupId",
    STATE_clientPhones:
      "id, name, number, clientId, dateUpdated, dateCreated, dateRemoved",
    STATE_addresses:
      "id, cep, city, dateCreated, dateUpdated, neighborhood, state, status",
    STATE_clientAddresses:
      "id, addressId, clientId, complement, dateCreated, dateUpdated, dateRemoved, name, number, status",
