<template>
    <div id="page-login">
        <div class="login__container">
            <div class="container__header"><h3>GESTAON ERP</h3></div>
            <div class="container__body">
                <form autocomplete="off">
                    <div>
                        <label>E-mail</label> <input style="display:none;" />
                        <input
                                type="email"
                                class="input"
                    ...
                    <div>
                        <label>Senha</label> <input style="display:none;" />
                        <input
                                type="password"
                                class="input"
                                placeholder="*******"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions("request-queue", ["clearRequestProcessingQueue"]),
            ...mapActions("chat-queue", ["clearChatProcessingQueue"]),
            login() {
                const vm = this;
                window.showAppLoading();
                window.setAppLoadingText("Tentando realizar o login...");
                vm.authenticate(this.form)
                    .then(() => {
