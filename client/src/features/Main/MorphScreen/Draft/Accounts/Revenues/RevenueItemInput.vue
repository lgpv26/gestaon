...
<script>
    ...
    export default {
        ...
        props: ['revenueGroup','revenueItems'],
        data(){
            return {
                ...
                revenueGroupMenuList: [
                    {
                        ...
                        type: 'system',
                        param: {
                            revenueGroupId: this.lastHoveredGroupId
                        },
        ...
        methods: {
            ...
            saveRevenueGroupName(revenueGroup){
                const renameValue = utils.removeReactivity(revenueGroup.form.rename)
                const emitData = {
                ...
                const revenueGroupIndex = this.revenues.revenueGroups.findIndex((t) => revenueGroup.id === t.id)
                this.commitSocketChanges('revenues.revenueGroups[' + revenueGroupIndex + ']')
                /*
