...
module.exports = {
  ...
  postSettings: ({
    ...
    RequestPayment.belongsTo(Request, {
      as: "request",
      foreignKey: "requestId"
    });
    RequestPayment.belongsTo(PaymentMethod, {
      as: "paymentMethod",
      foreignKey: "paymentMethodId"
    });
    RequestPayment.hasOne(RequestPaymentBill, {
    ...
    RequestPayment.hasMany(RequestPaymentTransaction, {
