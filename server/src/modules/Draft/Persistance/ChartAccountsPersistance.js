...
const chartAccountsController = require('../../../controllers/chart-accounts.controller')

const Controller = require('../../../models/Controller')

module.exports = class ChartAccountsPersistance extends Persistance {
    ...
    constructor(server) {
        ...
        this.chartAccountsController = chartAccountsController(this.server);
    ...
    /**
     * Start Chart Accounts persistence from draft to definitive (MySQL)
     * @returns {Promise}
     */
    start() {
