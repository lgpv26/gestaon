  ...
  return {
    ...
    actions: {
      ...
      requestBoardLoad(ctx) {
        server.io.sockets.sockets[ctx.params.activeSocketId].join(
          "company/" + ctx.params.companyId + "/request-board"
        ); // subscribe the user to its request-board company channel
